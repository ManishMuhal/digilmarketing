...
export default function ConversionRateOptimization() {
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Conversion Rate Optimization (CRO)">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <h3 className="services-details__title-1">Maximize Your Website&apos;s Conversion Potential</h3>
                                <div className="services-details__bdr"></div>
                                <p className="services-details__text-1">Our conversion rate optimization services help you turn more visitors into customers by improving your website&apos;s design, user experience, and conversion funnels. We use data-driven strategies to identify and fix conversion barriers.</p>
                                <p className="services-details__text-2">Through A/B testing, user research, and analytics, we optimize every element of your website to increase conversions, improve user experience, and boost your bottom line.</p>
                                ...
                                <h4 className="services-details__title-2">CRO Core Features</h4>
                                <p className="services-details__text-3">Comprehensive conversion analysis and audit. A/B testing and multivariate testing. User experience optimization. Landing page optimization. Funnel analysis and improvement. Conversion tracking and analytics.</p>
