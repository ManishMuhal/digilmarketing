...
export default function InfluencerMarketing() {
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Influencer Marketing">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <h3 className="services-details__title-1">Leverage Influencer Power to Grow Your Brand</h3>
                                <div className="services-details__bdr"></div>
                                <p className="services-details__text-1">Our influencer marketing services connect your brand with authentic voices that resonate with your target audience. We identify, vet, and partner with influencers who align with your brand values and can authentically promote your products or services.</p>
                                <p className="services-details__text-2">From micro-influencers to celebrity partnerships, we create strategic campaigns that build trust, increase engagement, and drive conversions through genuine influencer relationships.</p>
                                ...
                                <h4 className="services-details__title-2">Influencer Marketing Core Features</h4>
                                <p className="services-details__text-3">Influencer identification and vetting. Campaign strategy and planning. Content creation and collaboration. Performance tracking and analytics. Relationship management. ROI measurement and reporting.</p>
