...
export default function OnlineReputationManagement() {
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Online Reputation Management (ORM)">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <h3 className="services-details__title-1">Protect and Enhance Your Online Reputation</h3>
                                <div className="services-details__bdr"></div>
                                <p className="services-details__text-1">Our online reputation management services help you monitor, protect, and improve your brand&apos;s online presence. We identify potential issues and implement strategies to build trust and credibility with your audience.</p>
                                <p className="services-details__text-2">From brand monitoring and review management to crisis response and reputation repair, our team ensures your online reputation reflects the positive aspects of your business and helps you maintain customer trust.</p>
                                ...
                                <h4 className="services-details__title-2">ORM Core Features</h4>
                                <p className="services-details__text-3">Comprehensive brand monitoring across all platforms. Review management and response strategies. Crisis management and reputation repair. Content creation for reputation enhancement. Social media reputation monitoring. Regular reputation reports and insights.</p>
