...
export default function SocialMediaMarketing() {
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Social Media Marketing (SMM)">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <h3 className="services-details__title-1">Build Your Brand Presence with Strategic Social Media Marketing</h3>
                                <div className="services-details__bdr"></div>
                                <p className="services-details__text-1">Our social media marketing services help you build a strong online presence, engage with your audience, and drive meaningful interactions across all major social platforms. We create comprehensive strategies that align with your brand goals.</p>
                                <p className="services-details__text-2">From content creation and community management to targeted advertising and analytics, our team ensures your social media presence drives engagement, builds loyalty, and converts followers into customers.</p>
                                ...
                                <h4 className="services-details__title-2">Social Media Marketing Core Features</h4>
                                <p className="services-details__text-3">Platform-specific content strategy and creation. Community management and engagement. Social media advertising campaigns. Influencer partnerships and collaborations. Performance monitoring and analytics. Crisis management and reputation monitoring.</p>
