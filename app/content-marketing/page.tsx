...
export default function ContentMarketing() {
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Content Marketing">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <h3 className="services-details__title-1">Create Engaging Content That Drives Results</h3>
                                <div className="services-details__bdr"></div>
                                <p className="services-details__text-1">Our content marketing services focus on creating valuable, engaging content that attracts, educates, and converts your target audience. We develop comprehensive content strategies that establish your brand as an industry authority.</p>
                                <p className="services-details__text-2">From blog posts and articles to infographics and whitepapers, our team creates content that resonates with your audience and drives meaningful business outcomes across all marketing channels.</p>
                                ...
                                <h4 className="services-details__title-2">Content Marketing Core Features</h4>
                                <p className="services-details__text-3">Comprehensive content strategy development. Multi-format content creation (blogs, videos, infographics). SEO-optimized content for better search visibility. Content distribution and promotion. Performance tracking and optimization. Editorial calendar management.</p>
