...
export default function AnalyticsReporting() {
    return (
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Analytics & Reporting">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <h3 className="services-details__title-1">Data-Driven Insights for Better Marketing Decisions</h3>
                                <div className="services-details__bdr"></div>
                                <p className="services-details__text-1">Our analytics and reporting services provide comprehensive insights into your marketing performance across all channels. We track, measure, and analyze your campaigns to ensure you&apos;re getting maximum ROI from your marketing investments.</p>
                                <p className="services-details__text-2">From Google Analytics setup and custom dashboards to detailed performance reports, our team provides actionable insights that help you optimize your marketing strategies and achieve your business goals.</p>
                                ...
                                <h4 className="services-details__title-2">Analytics & Reporting Core Features</h4>
                                <p className="services-details__text-3">Google Analytics and Google Tag Manager setup. Custom dashboard creation and monitoring. Multi-channel attribution modeling. Performance reporting and insights. ROI analysis and optimization recommendations. Real-time campaign monitoring.</p>
